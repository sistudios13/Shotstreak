    ...
    <header id="navbar" class="sticky shadow-md bg-white dark:bg-darkslate  top-0 w-full z-20">
        <nav class="flex justify-between lg:container mx-auto px-4 lg:px-6 py-3 lg:py-0 " x-data="{isOpen : false, current: 1}" @click.outside="() => { if(window.innerWidth < 1024) {isOpen = false} }" x-init="if(window.innerWidth >= 1024) {isOpen = true}">
            ...
            <ul class="absolute shadow-md mt-[70px] lg:py-3 text-almostblack dark:text-lightgray bg-white dark:bg-darkslate pb-8 flex-col items-end flex w-full lg:static top-0 right-0 p-4 lg:text-lg float-right gap-4 lg:p-0 lg:justify-end lg:items-center lg:flex-row lg:shadow-none lg:mt-0 text-xl" x-show="isOpen" x-cloak x-transition:enter="transition ease-out duration-200"
                ...
                <li><a href="p_profile.php" class="cursor-pointer text-coral">Profile</a></li>
            ...
            <div class="bg-white dark:bg-darkslate p-6 rounded-lg shadow-md flex flex-col gap-4">
                ...
                <div class="flex flex-col items-start justify-between gap-4 ">
                    ...
                    <div class="pt-2 flex items-center gap-2">
                        ...
                        <a href="p_export.php" class="py-2 dark:text-lightgray font-semibold">Export All Data</a>
                    </div>
            ...
            <div class="bg-white dark:bg-darkslate p-6 rounded-lg shadow-md" x-data="{change: false}">
                ...
                <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-2 items-center mb-3">
                            ...
                            <a @click="change = !change" class=" dark:text-lightgray select-none cursor-pointer">Change Password</a>
                        </div>
                ...
                <div x-data="{de: false}" @click.away="de = false" class="pt-4 flex gap-2 items-center">
                    <svg class='size-6' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path fill="#ff6f61" d='M135.2 17.7C140.6 6.8 151.7 0 163.8 0L284.2 0c12.1 0 23.2 6.8 28.6 17.7L320 32l96 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 96C14.3 96 0 81.7 0 64S14.3 32 32 32l96 0 7.2-14.3zM32 128l384 0 0 320c0 35.3-28.7 64-64 64L96 512c-35.3 0-64-28.7-64-64l0-320zm96 64c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16z'/></svg>
                    <a @click="de = !de" class=" select-none dark:text-lightgray h-[32px] pt-1 text-almostblack cursor-pointer">Delete Account</a>
